      ...
      <div className="container">
        <div className="content-container">
          ...
          <div className="section">
            <h2 className="section-title">1. Acceptation des conditions</h2>
            <p className="text">
          ...
          <div className="section">
            <h2 className="section-title">2. Utilisation de l'application</h2>
            <p className="text">
          ...
          <div className="section">
            <h2 className="section-title">4. Confidentialité</h2>
            <p className="text">
          ...
          <div className="section">
            <h2 className="section-title">6. Modifications des conditions</h2>
            <p className="text">
          ...
          <div className="section">
            <h2 className="section-title">7. Loi applicable</h2>
            <p className="text">
